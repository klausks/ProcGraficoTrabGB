...
public:
	...
	//Métodos pricipais
	void initialize(GLuint width, GLuint height, string filePath);
	void run();
	void finish();
	...
	void detectStickerSelection();
	void detectFilterSelection();
	bool detectClickOnObject(GLFWwindow* window, Sprite* object);
